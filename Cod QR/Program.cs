...
int max_width = sizeForVersion(n);
...
void ReadMatrixFromFile(string filePath, int[,] mat)
{
...
ReadMatrixFromFile("input.txt", mat);
int[,] mat1 = new int[n, n];
mask = calculeaza(mat, mat1, n);
